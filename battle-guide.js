export const ENEMY_GUIDE={
 mushroom:{name:'蹦跳蘑菇',attack:'蓄力后向锁定位置弹跳扑击',tip:'看到脚下的橙色爪痕就侧移，别沿直线后退。'},
 wolf:{name:'林地狼',attack:'绕侧接近，再向锁定方向猛扑',tip:'等它压低身体后闪到侧面。'},
 golem:{name:'岩甲石怪',attack:'缓慢举臂后震地，近身范围较大',tip:'观察震地前的橙色标记，离开范围再回身攻击。'},
 spitter:{name:'吐毒巫兽',attack:'抬杖吐出毒雾，在紫色毒雾内持续伤人',tip:'毒雾落地后会停留一阵，不要站回去。'},
 shaman:{name:'林地祭司',attack:'治疗受伤怪物；无人受伤时施放减速咒',tip:'优先处理祭司，并离开青绿色咒印。'},
